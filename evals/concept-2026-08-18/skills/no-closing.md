...
- v1.5 (2026-08-18): body migrated to entries (23 entries, 3 of them payload templates) — content unchanged; pilot of ACDSL-SKILL-005 / rules render-skill / eval v2
- v1.4 (2026-08-11): declares its context set via the frontmatter context: line (ACTION-CONCEPT-*, FACT-*) — entries arrive injected at invocation
